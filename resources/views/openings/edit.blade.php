...
@section('header')
    <div class="page-header">
        <a href="/openings"><i class="fa fa-arrow-left"></i> Back to Jobs List</a>
          <hr>
        <h2><i class="fa fa-user main-color"></i> Edit Job </h2>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('openings.update', $opening->id) }}" method="POST">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class="form-group @if($errors->has('title')) has-error @endif">
                       <label for="title-field">Title</label>
                    <input type="text" id="title-field" name="title" class="form-control" value="{{ $opening->title }}"/>
                       @if($errors->has("title"))
                    ...
                    <input type="text" id="type-field" name="type" class="form-control" value="{{ $opening->type }}"/>
                       @if($errors->has("type"))
                    ...
                    <textarea class="form-control" id="description-field" rows="3" name="description">{{ $opening->description }}</textarea>
                    ...
                    <textarea class="form-control" id="duties-field" rows="3" name="duties">{{ $opening->duties }}</textarea>
                    ...
                    <textarea class="form-control" id="qualifications-field" rows="3" name="qualifications">{{ $opening->qualifications }}</textarea>
                    ...
                    <textarea class="form-control" id="apply-field" rows="3" name="apply">{{ $opening->apply }}</textarea>
                       @if($errors->has("apply"))
                    ...
                    <input type="text" id="hours-field" name="hours" class="form-control" value="{{ $opening->hours }}"/>
                       @if($errors->has("hours"))
                    ...
                    <input type="text" id="pay-field" name="pay" class="form-control" value="{{ $opening->pay }}"/>
                       @if($errors->has("pay"))
                    ...
                    <input type="text" id="duration-field" name="duration" class="form-control" value="{{ $opening->duration }}"/>
                    ...
                    <input type="text" id="location-field" name="location" class="form-control" value="{{ $opening->location }}"/>
                    ...
                    <input type="text" id="updated-field" name="updated" class="form-control" value="{{ $opening->updated }}"/>
                    ...
                    <div class="form-group @if($errors->has('entered_by')) has-error @endif">
                       <label for="entered_by-field">Entered_by</label>
                    <input type="text" id="entered_by-field" name="entered_by" class="form-control" value="{{ $opening->entered_by }}"/>
